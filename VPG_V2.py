"""
# A list of action each iteration
"""
...
def choose_action(state) -> list:
    ...
    for i in range(env.pair_num):
        state[-1] = i  # increase the last bit of the state (Tx_No, position)
...
for i in range(EPISODE_NUM):
    ...
    result = np.sum(rewards)/env.pair_num
